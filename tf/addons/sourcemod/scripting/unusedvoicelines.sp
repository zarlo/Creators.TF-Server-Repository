...
public void OnPluginStart()
{
	...
	cvDontFailAgain = CreateConVar("uv_dontfailagain", "1", "Enable/Disable the 'Dont Fail Me Again' announcer voiceline at the start of the round if the team failed last round");
