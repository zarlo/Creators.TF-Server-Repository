...
#define PLUGIN_AUTHOR "Fishy & Nanochip"
...
public void OnPluginStart()
{
	...
	g_cVoteKickEvent = CreateConVar("rf_scr_event_votekick", "1", "Enable votekick events", FCVAR_NONE, true, 0.0, true, 1.0);
...
public Action Cmd_VoteKick(int client, const char[] cmd, int argc)
{
	if (!g_cVoteKickEvent.BoolValue)
